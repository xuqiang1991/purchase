	...
	<form class="layui-form changePwd" id="cpwd">
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" value="${admin.fullname}" disabled class="layui-input layui-disabled">
		    </div>
		</div>
		<div class="layui-form-item">
		    <label class="layui-form-label">重置密码</label>
		    <div class="layui-input-block">
		    	<input type="password"  value="" placeholder="请输入重置密码" lay-verify="newPwd" id="newPwd" class="layui-input pwd" name="newPwd">
		    </div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
		    <div class="layui-input-block">
		    	<button class="layui-btn" lay-submit="" lay-filter="pwdReset">立即修改</button>
