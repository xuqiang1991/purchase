...
<form class="layui-form" style="width: 90%; padding: 20px 0px 0px 20px;" id="projectMangerForm">
    <input type="hidden" id="projectMangerId" name="id" value="${projectManger.id}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <label class="layui-form-label css-required">进度方案</label>
            <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">签定日期</label>
            <div class="layui-input-inline">
    ...
    <div class="layui-tab">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <table id="instructOrderList" class="instructOrderList" lay-filter="instructOrderList"></table>
            </div>
        </div>
    </div>
</form>
...
<script type="text/html" id="radioTpl">
    <input type="radio" name="instructOrderId" value="{{d.id}}" title=" " lay-filter="radiodemo">
</script>
<script type="text/html" id="instructType">
    {{#  if(d.instructType == 0){ }}
    发展商指令
    {{#  } else{ }}
    内部指令
...
<script type="text/html" id="createAdmin">
    {{#  if(d.createAdmin != null && d.createAdmin != ''){ }}
        {{d.createAdmin.fullname}}
    {{#  } }}

</script>
<script type="text/html" id="editAdmin">
    {{#  if(d.editAdmin != null && d.editAdmin != ''){ }}
        {{d.editAdmin.fullname}}
    {{#  } }}
</script>
</body>
</html>