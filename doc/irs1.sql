...
CREATE TABLE `biz_purchase_order` (
  ...
  `purchase_no` varchar(32) DEFAULT NULL COMMENT '采购订单号',
  ...
  `status` int(10) DEFAULT NULL COMMENT '单据状态(0：未提交,1：已提交,2：成本部已审核,3：工程部已审核,4：总经理已审核,5：已合同编号)',
  ...
  `project_depart_user` varchar(64) DEFAULT NULL COMMENT '工程部审人',
  `project_depart_date` datetime DEFAULT NULL COMMENT '工程部审批时间',
  `project_depart_opinion` varchar(255) DEFAULT NULL COMMENT '工程部审批意见',
...
CREATE TABLE `biz_purchase_order_detail` (
  ...
  `purchase_no` varchar(32) DEFAULT NULL COMMENT '采购订单ID',
  `model` varchar(100) DEFAULT NULL COMMENT '规格',
  `unit` varchar(10) DEFAULT NULL COMMENT '单位',
  `price` decimal(10,2) DEFAULT NULL COMMENT '单价',
  `amount` double(8,2) DEFAULT NULL COMMENT '单价',
